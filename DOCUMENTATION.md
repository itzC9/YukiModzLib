...
## Booting the Library
```lua
local TrinityLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/itzC9/Trinity/main/source')))()
```
...
## Creating a Window
```lua
local Window = TrinityLib:AddWindow({Name = "Title of the library", HidePremium = false, SaveConfig = true, ConfigFolder = "TrinityTest"})
